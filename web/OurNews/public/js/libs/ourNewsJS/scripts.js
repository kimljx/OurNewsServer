...
//     });
    ...
    //控制navigation的active切换
    jQuery("a[name='personalPage']").click(function (evt) {
        jQuery('.side-navigation').find('li.active').removeClass('active');
        jQuery('.side-navigation').find('li.nav-active').removeClass('nav-active');
        jQuery('.side-navigation').find('span.active').removeClass('active');
